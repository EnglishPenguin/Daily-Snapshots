...
def run():
    file_path = 'M:/FPP-CPP/Revenue Cycle Operations Training/Projects/RPA Project/TPL Alert'
    ...
    (df['RetrievalDescription'] == 'C00-Eligibility initiated and health plans reordered'),
    'Success',
    'Exception'
    )
    ...
    df2 = pd.DataFrame(df,columns=['INVNUM', 'StatusCode_Description', 'Business Status'])
    ...
    df2.rename(columns={'INVNUM': 'Account Number', 'StatusCode_Description': 'Exception Description'}, inplace=True)
    ...
    bar_graph_filename = f'U:/zORCCA TEAM/Daily Analysis/eCare Next/{fd_MMDDYYYY}_TPL_Alert.png'
    ...
    <p>Link to File can be found: <a href="file:///{file_path}/eCareNext_TPLAlert_Outbound_{fd_MMDDYYYY}.xlsx">here</a></p>
    ...
    mail.Subject = f'TPL Alert Daily Snapshot - {fd_MM_DD_YYYY}'
