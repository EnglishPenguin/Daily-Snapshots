...
def run():
    ...
    (df['RetrievalDescription'] == 'C00-Health plans reordered'),
    'Success',
    'Exception'
    )
    ...
    bar_graph_filename = f'U:/zORCCA TEAM/Daily Analysis/eCare Next/{fd_MMDDYYYY}_MCR_Not_Primary.png'
    ...
    <p>Link to File can be found: <a href="file:///{file_path}/eCareNext_SOARIAN_Outbound_{fd_MMDDYYYY}.xlsx">here</a></p>
