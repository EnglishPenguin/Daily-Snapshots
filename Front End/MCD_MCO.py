...
def run():
    ...
    bar_graph_filename = f'U:/zORCCA TEAM/Daily Analysis/LIJ CBO/{fd_MMDDYYYY}_MCD_MCO.png'
    ...
    <p>Link to File can be found: <a href="file:///{file_path}/eCareNext_MCDMCO_Outbound_{fd_MMDDYYYY}.xlsx">here</a></p>
    ...
    mail.Subject = f'Medicaid MCO Daily Snapshot - {fd_MM_DD_YYYY}'
