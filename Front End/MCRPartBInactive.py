...
def run():
    ...
    <p>Link to File can be found: <a href="file:///{file_path}/eCareNext_MCRPartB_Outbound_{fd_MMDDYYYY}.xlsx">here</a></p>
    ...
    mail.Subject = f'Medicare Part B Inactive Daily Snapshot - {fd_MM_DD_YYYY}'
