...
def run():
    ...
    (df['RetrievalDescription'] == 'C00-DX pointers updated') |
    (df['RetrievalDescription'] == 'C00-Email sent to provider') ,
    'Success',
    'Exception'
    )
    ...
    bar_graph_filename = f'U:/zORCCA TEAM/Daily Analysis/Coding/{fd_MMDDYYYY}_CM6146.png'
    ...
    <p>Link to File can be found: <a href="file:///{file_path}/GECB_TES6146_Outbound_{fd_MMDDYYYY}.xlsx">here</a></p>
    ...
    mail.Subject = f'ClaimsManager 6146 Daily Snapshot - {fd_MM_DD_YYYY}'
